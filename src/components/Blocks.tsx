            ...
            <div className="mt-8 space-y-4 border-t border-ink-700 pt-7">
              ...
              <div className="rounded-md border border-urgent-600/50 bg-urgent-600/10 p-4">
                <p className="flex items-start gap-2 text-[0.9375rem]">
                  <AlertIcon className="mt-0.5 h-5 w-5 shrink-0 text-urgent-500" />
                  <span>
                    <strong className="font-semibold text-white">Leaking right now?</strong> Skip
                    the form —{" "}
                    <a
                      href={business.phone.emergency.href}
                      className="font-semibold text-urgent-500 underline underline-offset-2 hover:text-white"
                    >
                      {business.phone.emergency.display}
                    </a>{" "}
                    goes straight to the on-call foreman, 24/7.
                  </span>
                </p>
              </div>
            </div>
