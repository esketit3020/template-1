...
export function Header() {
  ...
  return (
    <>
      {/* ── Utility strip: rating + emergency. Hidden on mobile to save height;
        ...
        <div className="shell flex h-9 items-center justify-between text-[0.8125rem]">
          ...
          <div className="flex items-center gap-5">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 font-semibold text-urgent-500 hover:text-white"
            >
          ...
          >
            <nav aria-label="Mobile" className="shell py-4">
              ...
              <div className="mt-5 space-y-2.5">
                ...
                <a href={business.phone.emergency.href} className="btn btn-urgent w-full">
