...
import { AlertIcon, MailIcon, MapPinIcon, PhoneIcon, StarIcon } from "./Icons";
            ...
            <div>
              ...
              <address className="mt-5 space-y-2.5 text-[0.9375rem] not-italic">
                ...
                <a
                  ...
                  className="flex items-start gap-2.5 hover:text-white"
                >
                  <AlertIcon className="mt-0.5 h-4 w-4 shrink-0 text-urgent-500" />
                  <span>
                    <strong className="font-semibold text-white">
                      {business.phone.emergency.display}
                    </strong>
                    <span className="block text-[0.8125rem] text-ink-400">
                      24/7 storm &amp; emergency leaks
                    </span>
                  </span>
                </a>
