    ...
    <form onSubmit={onSubmit} noValidate className={className}>
      ...
      <div className="mt-4">
        ...
        <textarea
          ...
          rows={compact ? 3 : 4}
          maxLength={1200}
          placeholder="A line or two is plenty — e.g. 'stain on the ceiling in the back bedroom, appeared after the last storm', or 'roof is about 30 years old and has never been done'."
      ...
      <p className="mt-4 text-[0.8125rem] leading-relaxed text-ink-500">
        ...
        . If water is coming in right now, use the 24/7 storm line on{" "}
        <a
          href={business.phone.emergency.href}
          className="font-semibold text-urgent-600 underline underline-offset-2"
        >
