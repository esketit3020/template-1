  ...
  return (
    <>
      ...
      <PageHeader
        ...
        intro={`Based out of our Woolloongabba depot, our employed roofing crews are on roofs across these 20 primary suburbs every week. ${yearsTrading()} years local experience, QBCC licensed, and 4-hour storm make-safe commitment.`}
            ...
            <div>
              <div className="sticky top-28">
                ...
                <div className="mt-5 rounded-lg border border-ink-200 bg-white p-5">
                  ...
                  <p className="mt-2 text-xs leading-relaxed text-ink-600">
                    Being based directly off Old Cleveland Road and the M3 gives our crews fast access across the entire southside. In severe storms, make-safe crews are dispatched immediately.
                  </p>
