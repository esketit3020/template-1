...
export const metadata: Metadata = {
  ...
  description:
    "Comprehensive roofing services across the Brisbane southside. Restorations from $4,800, leak repairs from $340, Colorbond metal re-roofing, gutters, and 24/7 emergency storm response. QBCC 15234876.",
