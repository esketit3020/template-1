...
export const metadata: Metadata = {
  ...
  description:
    "QBCC-licensed Brisbane southside roofers since 2009. Roof restorations from $4,800, repairs, re-roofing and 24/7 storm damage. 4.9★ from 187 reviews. 25-year workmanship warranty.",
  ...
  keywords: [
    ...
    "storm damage roof repair Brisbane",
