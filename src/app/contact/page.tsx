...
export const metadata: Metadata = {
  ...
  description:
    "Request a free roof inspection and fixed-price quote within 48 hours from Ironbark Roofing Co. Woolloongabba depot, office phone (07) 3856 4120, and 24/7 storm line 0447 882 310. QBCC 15234876.",
        ...
        <div className="shell">
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
            ...
            <div className="space-y-6">
              {/* Emergency Callout */}
              <div className="rounded-xl border-2 border-urgent-600 bg-urgent-600/10 p-6">
                <div className="flex items-center gap-2.5">
                  <AlertIcon className="h-6 w-6 text-urgent-600" />
                  <h3 className="font-display text-lg font-bold text-urgent-700">
                    24/7 Emergency Storm Line
                  </h3>
                </div>
                <p className="mt-2 text-sm leading-relaxed text-ink-700">
                  Active water ingress? Don&rsquo;t wait for a form response. Ring our on-call foreman directly for rapid make-safe within 4 hours.
                </p>
                <a
                  href={business.phone.emergency.href}
                  className="mt-4 inline-flex items-center gap-2 font-display text-2xl font-bold text-urgent-700 hover:text-urgent-800"
                >
