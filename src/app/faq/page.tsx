...
export const metadata: Metadata = {
  ...
  description:
    "Honest answers to the questions we get asked most: restoration costs in Brisbane, insurance coverage for storm damage, 25-year warranties, and subcontractor policies. QBCC 15234876.",
  ...
  return (
    <>
      ...
      <PageHeader
        ...
        intro="Straightforward answers about pricing, insurance claims, restoration longevity, and how we work — sourced directly from customer enquiries to our office."
