...
export const metadata: Metadata = {
  ...
  description:
    "Founded by Dave Whitlock in 2009 after the Brisbane hailstorms. Seventeen years later, still family-run, employing every crew member on our books. QBCC 15234876, 25-year workmanship warranty.",
          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
            <div className="prose-body">
              <h2 className="h-section text-ink-900">
                Started with one ute after the 2008 Brisbane hailstorms.
              </h2>
              <p className="mt-5 text-lg leading-relaxed text-ink-800">
                In November 2008, a supercell hailstorm battered Brisbane&rsquo;s southside. In the months that followed, Dave Whitlock saw hundreds of families living under blue tarps for three, six, even nine months while fly-by-night operators took deposits and disappeared.
              </p>
