...
export const business = {
  ...
  foundingStory:
    "Dave Whitlock started Ironbark with one ute after the 2008 Brisbane hailstorms, when he saw how many southside families were left living under tarps for months. Seventeen years on it is still a family business — his daughter Nina runs the office, and every crew member is on the books, not subcontracted.",
  ...
  phone: {
    ...
    /** Onboarding §2: rings the on-call foreman directly, not the office. */
    emergency: { display: "0447 882 310", href: "tel:+61447882310" },
  },
  ...
  differentiators: [
    ...
    {
      title: "Storm make-safe within 4 hours",
      body:
        "When your roof opens up in a hailstorm the clock matters more than the quote. Ring the emergency line any hour and we will have a crew tarping and making safe within 4 hours anywhere in our primary area.",
      stat: "4 hr",
    },
    {
  ...
  process: [
    {
      ...
      body:
        "Ring the office or send the form — name, suburb and a line about the problem is plenty. If water is coming in right now, use the emergency line instead and skip the queue.",
    },
    {
      step: 2,
    ...
    },
    {
      ...
      body:
        "We walk the job with you, hand over the full photo record, and issue your written 25-year workmanship warranty certificate. Then we check in after the first big storm.",
    },
  ],
  ...
  team: [
    ...
    },
    {
      ...
      role: "Office Manager",
      bio:
        "Dave's daughter. Runs scheduling, the insurance paperwork and the follow-ups, and is the person who will actually answer when you ring the office.",
    },
    {
    ...
    {
      name: "Marco Ferreira",
      role: "Foreman — Metal Roofing & Storm Response",
      bio:
        "Colorbond accredited and the man on the end of the emergency phone most nights. If you get a 2am make-safe, it is usually Marco's crew.",
    },
  ],
} as const;
