...
export const primarySuburbs: Suburb[] = [
  {
    ...
    slug: "coorparoo",
    localNote:
      "Our depot is a seven-minute drive up Old Cleveland Road, so Coorparoo is usually the first suburb our storm crews reach.",
    housingNote:
  ...
  },
  {
    ...
    slug: "carindale",
    localNote:
      "Carindale's exposed ridgelines cop the westerly weather, and it is one of the suburbs we get called to most after a hailstorm.",
    housingNote:
