...
export const projects: Project[] = [
  ...
  {
    slug: "carindale-hail-insurance-repair",
    title: "Hail damage assessment and full insurance repair",
    suburb: "Carindale",
    serviceSlug: "storm-hail-damage",
    serviceName: "Storm & Hail Damage",
    completed: "July 2026",
    valueBand: "$18,000 – $25,000 (insurer funded)",
    duration: "Make-safe 3 hours, repair 6 days",
    summary:
      "Emergency tarping at 1:40am during the January hail event, then a full assessment, insurance report and replacement of 340m² of dented sheeting.",
    detail:
      "We were on site inside three hours and had the roof made safe before the second cell came through. The report we produced that night — drone imagery plus dent-density counts per roof plane — is what got the claim approved as a full replacement rather than a patch repair.",
    photo: null,
    plate: { hue: 205, profile: "hip" },
  },
  {
