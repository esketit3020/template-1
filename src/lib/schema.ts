...
export function organisationSchema() {
  return {
    ...
    description: `QBCC-licensed roofing contractor serving the Brisbane southside since ${business.foundedYear}. Roof restoration, replacement, repairs, storm damage, guttering and Colorbond metal roofing.`,
    url: siteUrl,
...
export function suburbServiceSchema(suburb: string) {
  return {
    ...
    description: `Roof restoration, repairs, replacement and storm damage response in ${suburb}, Brisbane. ${yearsTrading()} years trading, QBCC licence ${business.licence.number}.`,
    provider: { "@id": ORG_ID },
