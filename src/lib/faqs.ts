...
export const faqs: Faq[] = [
  ...
  {
    q: "Will my insurance cover storm damage, and do you deal with the insurer?",
    a: "Sudden storm and hail damage is usually covered; gradual wear, rust and lack of maintenance usually is not, and that distinction is exactly what an assessor will look for. We deal with insurers and their assessors every week during storm season. You get a written, photographed damage report in the format insurers expect, and we will talk to the assessor directly so you are not stuck relaying technical questions between us. What we will not do is tell you that worn-out roof damage is storm damage — that is fraud, and it is the fastest way to have a legitimate claim denied.",
    serviceSlug: "storm-hail-damage",
  },
  {
  ...
  {
    q: "How soon can you get here if my roof is leaking right now?",
    a: "If water is coming in, ring the emergency line on 0447 882 310 — it goes to the on-call foreman, not the office voicemail. We aim to have a crew on site making safe within 4 hours anywhere in our primary southside area, any hour of the day. During a major hail event that stretches, and we will be honest with you on the phone about where you sit in the queue rather than promising a time we cannot hold. For non-urgent inspections we are usually there within 3 business days.",
    serviceSlug: "storm-hail-damage",
  },
  {
