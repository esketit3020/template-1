 ...
 * replacement, metal roofing and all commercial work.
 */
...
export type Service = {
  ...
  intro: string;
  /** "from" price, or null for quote-only services. */
  ...
  /** Flags an urgent service so the page surfaces the emergency pathway. */
  urgent?: boolean;
...
export const services: Service[] = [
  {
    ...
    name: "Storm & Hail Damage Repairs",
    shortName: "Storm & Hail Damage",
    teaser: "24/7 make-safe, full insurance reports, and the repair done properly afterwards.",
    metaTitle: "Storm & Hail Damage Roof Repairs Brisbane | 24/7 Make-Safe",
    metaDescription:
      "Storm or hail damage on the Brisbane southside? Ironbark Roofing has a crew making safe within 4 hours, 24/7. Full insurance reports, QBCC licence 15234876.",
    intro:
      "When a Brisbane storm opens up a roof, the damage that costs you the most is usually the water that gets in over the next three days — not the hail itself. We run an on-call crew year round so we can tarp and make safe within 4 hours, then handle the assessment, the insurance report and the permanent repair.",
    fromPrice: null,
    priceNote:
      "Emergency make-safe is charged at a call-out rate we quote on the phone before we leave the depot. The repair itself is almost always claimable — we prepare the report your insurer needs and deal with the assessor directly.",
    icon: "storm",
    includes: [
      "Emergency tarping and make-safe, any hour",
      "Full photographic and drone damage assessment",
      "Insurance-ready written report and itemised scope",
      "We liaise with your insurer and their assessor directly",
      "Broken and cracked tile replacement, colour matched",
      "Hail-dented metal sheet and flashing replacement",
      "Internal ceiling and cornice water damage referral to our plasterer",
    ],
    signs: [
      "Water coming in during or after a storm",
      "Tiles on the lawn or visible gaps in the roof line",
      "Dents across metal sheeting or gutters after hail",
      "Ceiling stains that appeared or grew after a big blow",
      "Your insurer has asked for an independent roof report",
    ],
    duration: "Make-safe same day; permanent repair 1–4 days once the claim is approved",
    warrantyYears: 10,
    urgent: true,
    featured: true,
  },
  {
    ...
    metaTitle: "Roof Restoration Brisbane Southside | From $4,800 | Ironbark Roofing",
    metaDescription:
    ...
    fromPrice: "$4,800",
    priceNote:
      "From $4,800 for a standard single-storey tile roof up to about 200m². Two-storey, steep-pitch and heavily deteriorated roofs cost more — the fixed quote tells you exactly what yours is before you commit.",
    icon: "restoration",
    includes: [
  ...
  },
  {
    ...
    metaTitle: "Roof Repairs & Leak Detection Brisbane | From $340 | Ironbark Roofing",
    metaDescription:
    ...
    fromPrice: "$340",
    priceNote:
      "From $340 for a standard call-out and minor repair, including the leak trace. We quote anything larger on the spot before starting work, and we will tell you if it makes more financial sense to restore than to keep patching.",
    icon: "repair",
    includes: [
  ...
  },
  {
    ...
    fromPrice: null,
    priceNote:
      "Quote only. There is too much variance — pitch, access, batten condition, asbestos, whether we are changing material — for a 'from' figure to be honest. Residential re-roofs typically land between $16,000 and $34,000. The written quote is fixed.",
    icon: "replacement",
    includes: [
  ...
  },
  {
    ...
    metaTitle: "Gutter & Downpipe Replacement Brisbane | From $48/m | Ironbark Roofing",
    metaDescription:
    ...
    fromPrice: "$48 per metre",
    priceNote:
      "From $48 per metre for standard Colorbond quad gutter, supplied and installed, with old guttering removed. Fascia covers, box gutters and two-storey access are quoted separately.",
    icon: "gutter",
    includes: [
  ...
  },
  {
    ...
    fromPrice: null,
    priceNote:
      "Quote only. Priced on roof area, profile, pitch and access. We supply the full Colorbond colour range and will bring physical samples to the inspection rather than asking you to pick from a screen.",
    icon: "metal",
    includes: [
  ...
  },
  {
    ...
    metaTitle: "Roof Painting & Sealing Brisbane | From $3,900 | Ironbark Roofing",
    metaDescription:
    ...
    fromPrice: "$3,900",
    priceNote:
      "From $3,900 for a standard single-storey tile roof, including clean, treatment, primer and two membrane coats. Often bundled into a full restoration — ask us which makes more sense for your roof.",
    icon: "paint",
    includes: [
  ...
  },
  {
    ...
    metaTitle: "Whirlybird & Skylight Installation Brisbane | From $520 | Ironbark Roofing",
    metaDescription:
    ...
    fromPrice: "$520",
    priceNote:
      "From $520 for a standard whirlybird supplied and installed. Powered and solar vents and Velux skylights are quoted on the unit and your roof type.",
    icon: "vent",
    includes: [
